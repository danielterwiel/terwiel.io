    ...
    >
      <div className="flex items-center justify-between border-b border-slate-200 px-6 py-4">
        ...
        <button
          type="button"
          onClick={closeDialog}
          className="flex min-w-[44px] min-h-[44px] items-center justify-center rounded-md text-slate-500 transition-colors hover-hover:bg-slate-100 hover-hover:text-slate-700 focus:outline-none focus:ring-2 focus:ring-klein focus:ring-offset-2"
          ...
          <Form.Root className="flex flex-col gap-4" onSubmit={onSubmit}>
            ...
            <div className="flex gap-3 pt-4">
              <Form.Submit asChild>
                <button
                  type="submit"
                  className="flex-1 relative flex min-h-[44px] items-center justify-center rounded-lg bg-klein font-medium text-white shadow-lg transition-all duration-200 hover-hover:shadow-xl hover-hover:shadow-klein/30 focus:ring-2 focus:ring-klein focus:ring-offset-2 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              <button
                type="button"
                onClick={closeDialog}
                className="flex-1 relative flex min-h-[44px] items-center justify-center rounded-lg border border-slate-300 font-medium text-slate-900 transition-colors hover-hover:bg-slate-50 focus:ring-2 focus:ring-klein focus:ring-offset-2 focus:outline-none"
              >
                Cancel
              </button>
            </div>
