    ...
    <div className="flex flex-col min-h-screen overflow-visible">
      ...
      <main className="flex-1 flex flex-col md:flex-row landscape-mobile:flex-col p-4 md:px-6 md:pt-6 md:pb-0 md:gap-0 landscape-mobile:px-2 landscape-mobile:pt-0 landscape-mobile:pb-0 relative z-0 overflow-visible">
        ...
        */}
        ...
        <div className="w-full md:w-[calc(50%-1.75rem)] landscape-mobile:w-full md:flex landscape-mobile:block md:flex-col md:h-[calc(100vh-72px)] landscape-mobile:h-auto relative z-0 md:fixed landscape-mobile:relative md:top-[72px] md:left-0 pt-8 landscape-mobile:pt-0 md:pt-20">
          <StackCloud />
        </div>

        {/* Projects - full width on mobile, adjusted width on desktop */}
        <div className="w-full md:w-[calc(50%+1.75rem)] landscape-mobile:w-full md:overflow-y-auto landscape-mobile:overflow-visible md:min-h-0 landscape-mobile:min-h-auto relative z-10 overflow-visible pt-8 landscape-mobile:pt-0 md:ml-[calc(50%-1.75rem)] landscape-mobile:ml-0 min-h-screen landscape-mobile:min-h-auto">
          <Projects />
        </div>
      </main>
    </div>
